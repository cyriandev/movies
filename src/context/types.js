...
export const ON_AIR_LOADING = "ON_AIR_LOADING";
export const TV_LOADING = "MOVIE_LOADING";

export const ON_AIR_ERROR = "ON_AIR_ERROR";
export const TV_ERROR = "MOVIE_ERROR";

export const GET_ON_AIR = "GET_ON_AIR";
export const GET_TV = "GET_MOVIE";

export const CLEAR_ERRORS = "CLEAR_ERRORS";
export const CLEAR_TV_ERRORS = "CLEAR_TV_ERRORS";